...
VALUES('Boukachour' , 'Hadhoum'  , 1, 192, 364, 2023),
	...
	('Nivet'      , 'Laurence' , 5, 384, 576, 2023),
      ...
      ('Boukachour1', 'Jaouad'   , 5, 384, 576, 2023),
...
--UPDATE Module SET nbhpntut = 4 WHERE codMod = 'P3.01';
--UPDATE Module SET nbhpntut = 4 WHERE codMod = 'P1.02';
...
VALUES('R1.01',7,1,'3 CM d''1h30.',  6, 1, 2023),
      ...
      ('R2.02',7,2,           NULL, 13, 2, 2023),
      ('R3.14',2,1,    'NbSem tmp',  6, 1, 2023),
      ('R3.14',2,2,    'NbSem tmp', 13, 2, 2023),
      ('R3.14',2,3,    'NbSem tmp', 13, 2, 2023),
      ('R5.02',9,2,           NULL, 15, 2, 2023),
